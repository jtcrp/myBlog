...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2641333577ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=post">`blog`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=blog&table=accounts">`blog`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nodelogin&table=post">`nodelogin`.`post`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=nodelogin&table=accounts">`nodelogin`.`accounts`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grupoewe_2&table=users">`grupoewe_2`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grupoewe_2&table=usuarios">`grupoewe_2`.`usuarios`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grupoewe_2&table=materiais">`grupoewe_2`.`materiais`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grupoewe_2&table=historico_salario">`grupoewe_2`.`historico_salario`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grupoewe_2&table=forma_pgto">`grupoewe_2`.`forma_pgto`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=grupoewe_2&table=nome_conta">`grupoewe_2`.`nome_conta`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="57486b734475602a3f4149303a656b2d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="blog" targettable="post">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `post`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="accounts">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `accounts`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="post">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `post`  
ORDER BY `post`.`publishedAt` DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="post">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `post` ORDER BY `publishedAt` DESC </span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="blog" targettable="post">
                            <div class="action_content">
